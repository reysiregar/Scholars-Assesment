...
export function OptionButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onSelect}
      className={`w-full text-left p-3.5 sm:p-4.5 rounded-2xl border transition-all duration-200 flex items-start gap-3 sm:gap-3.5 group cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#0b57d0] min-h-[52px] sm:min-h-[58px] active:scale-[0.99] ${
        isSelected
    ...
    >
      <span
        className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all mt-0.5 sm:mt-0 ${
          isSelected
